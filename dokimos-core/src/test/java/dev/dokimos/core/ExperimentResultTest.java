                ...
                List.of(new RunResult(
                        ...
                        List.of(
                                new ItemResult(
                                        ...
                                        Map.of(),
                                        List.of(EvalResult.success("correctness", 0.9, "Correct answer"))),
                                new ItemResult(
                                        Example.of("Capital of Germany?", "Berlin"),
                                        Map.of(),
                                        List.of(EvalResult.success("correctness", 0.8, "Correct answer"))),
                                new ItemResult(
                                        Example.of("Capital of Italy?", "Rome"),
                                        Map.of(),
                                        List.of(EvalResult.failure(
                                                "correctness", 0.3, "Said Milan instead of Rome")))))));
    ...
    void shouldCalculatePassRate() {
        var result = new ExperimentResult(
                ...
                List.of(new RunResult(
                        ...
                        List.of(
                                new ItemResult(
                                        Example.of("What is the refund policy?", "30 days"),
                                        Map.of(),
                                        List.of(EvalResult.success("correctness", 0.9, "Accurate"))),
                                new ItemResult(
                                        Example.of("Can I return after 60 days?", "No"),
                                        Map.of(),
                                        List.of(EvalResult.failure("correctness", 0.3, "Incorrect response")))))));
    ...
    void shouldCalculateAverageScorePerEvaluator() {
        var result = new ExperimentResult(
                ...
                List.of(new RunResult(
                        ...
                        List.of(
                                new ItemResult(
                                        Example.of("How do I reset my password?", "Go to settings"),
                                        Map.of(),
                                        List.of(
                                                EvalResult.success("correctness", 0.8, "Accurate"),
                                                EvalResult.success("helpfulness", 0.9, "Clear instructions"))),
                                new ItemResult(
                                        Example.of("Where is my order?", "Check tracking page"),
                                        Map.of(),
                                        List.of(
                ...
                List.of(
                        ...
                        new RunResult(
                                ...
                                List.of(new ItemResult(
                                        Example.of("Q1", "A1"),
                                        Map.of(),
                                        List.of(EvalResult.success("accuracy", 0.6, "OK"))))),
                        new RunResult(
                                2,
                                List.of(new ItemResult(
                                        Example.of("Q1", "A1"),
                                        Map.of(),
                                        List.of(EvalResult.success("accuracy", 0.7, "Good")))))));
    ...
    void shouldReturnZeroStdDevForSingleRun() {
        var result = new ExperimentResult(
                ...
                List.of(new RunResult(
                        0,
                        List.of(new ItemResult(
                                Example.of("Q1", "A1"), Map.of(), List.of(EvalResult.success("score", 0.8, "")))))));
