...
class FaithfulnessEvaluatorTest {
    ...
    void shouldReturnPartialScoreWhenSomeClaimsNotSupported() {
        ...
        var evaluator =
                FaithfulnessEvaluator.builder().judge(mockJudge).threshold(0.8).build();
    ...
    void shouldReturnFullScoreWhenNoClaimsFound() {
        ...
        var evaluator = FaithfulnessEvaluator.builder().judge(mockJudge).build();
    ...
    void shouldDisableReasoningWhenConfigured() {
        JudgeLM mockJudge = new MockJudge().withTruths("""
                                                ["Truth"]
                                                """).withClaims("""
                                                ["Claim"]
                                                """).withVerdicts("""
    ...
    void shouldRespectCustomThreshold() {
        ...
        var evaluator =
                FaithfulnessEvaluator.builder().judge(mockJudge).threshold(0.4).build();
    ...
    void shouldHandleMalformedTruthsJson() {
        ...
        var evaluator = FaithfulnessEvaluator.builder().judge(brokenJudge).build();
    ...
    void shouldHandleMarkdownWrappedJsonResponses() {
        ...
        var evaluator = FaithfulnessEvaluator.builder().judge(judgeWithMarkdown).build();
