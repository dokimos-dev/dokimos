...
class RecallEvaluatorTest {
    ...
    void shouldWorkWithFieldBasedMatching() {
        ...
        var testCase = EvalTestCase.builder()
                .input("test query")
                .actualOutput(
                        "retrieved", List.of(Map.of("id", "doc_1", "score", 0.9), Map.of("id", "doc_2", "score", 0.8)))
                .expectedOutput("relevant", List.of(Map.of("id", "doc_1"), Map.of("id", "doc_3")))
                .build();
    ...
    void shouldWorkWithMultiFieldMatching() {
        ...
        var testCase = EvalTestCase.builder()
                ...
                .actualOutput(
                        "retrieved",
                        List.of(Map.of("subject", "Bill Gates", "predicate", "founded", "object", "Microsoft")))
                .expectedOutput(
                        "relevant",
                        List.of(
