...
public class OpenAIAgentEvaluationExample {
                    ...
                    Map.of(
                            ...
                            "properties",
                                    Map.of(
                                            ...
                                            "nights",
                                            Map.of("type", "integer", "description", "Number of nights")),
    ...
    public static void main(String[] args) {
        ...
        printResult(ToolArgumentHallucinationEvaluator.builder()
                .judge(judge)
                .build()
                .evaluate(testCase));
        printResult(ToolNameReliabilityEvaluator.builder()
                .judge(judge)
                .build()
                .evaluate(EvalTestCase.builder().metadata("tools", TOOLS).build()));
        printResult(ToolDescriptionReliabilityEvaluator.builder()
                .judge(judge)
                .build()
                .evaluate(EvalTestCase.builder().metadata("tools", TOOLS).build()));
    }
