    ...
    public static void main(String[] args) {
        ...
        Dataset dataset = Dataset.builder()
                ...
                .addExample(Example.of(
                        "What is your return policy?", "We offer a 30-day money-back guarantee on all purchases."))
                .addExample(Example.of("How long does shipping take?", "Standard shipping takes 5-7 business days."))
                .addExample(Example.of(
        ...
        List<Evaluator> evaluators = List.of(
                ExactMatchEvaluator.builder().threshold(0.5).build(),
        ...
        System.out.println("  Conciseness: " + String.format("%.2f", result.averageScore("Conciseness")));
        System.out.println();
        ...
        result.itemResults().forEach(item -> {
            ...
            item.evalResults()
                    .forEach(eval -> System.out.println("  • " + eval.name() + ": "
                            + String.format("%.2f", eval.score()) + (eval.success() ? " ✓" : " ✗")));
        });
        System.out.println();
        System.out.println("=".repeat(60));
    }
