...
public class SpringAiRAGExample {
    ...
    public static void main(String[] args) {
        ...
        List<Document> documents = List.of(
                new Document("We offer a 30-day money-back guarantee on all purchases. " + "No questions asked."),
                new Document(
        ...
        Dataset dataset = Dataset.builder()
                ...
                .addExample(Example.of("What warranty do you offer?", "1-year warranty"))
                .build();
        ...
        Task ragTask = example -> {
            ...
            List<String> context = retrievedDocs.stream().map(Document::getText).toList();
        ...
        result.itemResults().forEach(item -> {
            ...
            context.forEach(ctx -> System.out.println("  • " + ctx.substring(0, Math.min(60, ctx.length())) + "..."));
            System.out.println();
